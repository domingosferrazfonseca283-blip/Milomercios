...
async function init() {
  ...
  if (!orders.length) {
    document.getElementById('orders-list').innerHTML = '<div class="empty-state"><i class="fas fa-bag-shopping"></i><h3>Ainda não tem encomendas</h3><p>Explore o marketplace e encontre o que procura.</p><a class="btn" href="index.html">Explorar produtos</a></div>';
    return;
  }
